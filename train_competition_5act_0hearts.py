"""Competition map training with 5 actions and default hearts (5).

Matches exact competition settings: initial_hearts=None → CvCConfig.INITIAL_HEARTS * wealth = 5.
Uses 5-action space (NoVibesVariant) which showed 2x better alignment
than 12-action on the competition map.
"""
