"""Competition map, FIXED seed, 3 agents, 4000 steps.

Fewer agents = less congestion, longer episodes = more time to learn navigation.
Fixed seed 42 = must learn actual map navigation paths.
...
competition_basic.teams = {
    "cogs": CogTeam(name="cogs", num_agents=3, wealth=1, initial_hearts=15),
}
