"""Training with longer episodes (2000 steps) to force heart depletion.

With 15 initial hearts and 2000 steps, hearts deplete mid-episode.
Agents must learn to mine+craft hearts in the second half to sustain alignment.
