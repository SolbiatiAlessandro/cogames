"""Competition map: 5-action, 15 hearts, 10000 steps (FULL competition length).

Training at actual competition episode length forces the model to learn long-horizon
navigation. Previous configs (1000-2000 steps) taught hub interactions but not
junction navigation because episodes ended before agents needed to explore far.

Key changes vs 2k config:
- 10000 steps matching competition exactly
- Added cell.visited exploration reward to incentivize leaving hub area
- Stronger junction alignment reward (2.0 vs 1.0)
- Stronger aligner gear bonus (1.0 vs 0.5)
"""
...
competition_basic.max_steps = 10000
