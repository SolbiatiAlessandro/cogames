"""Competition map: 5-action, 15 hearts, 1000 steps, exploration reward.

Key changes from previous 5-act configs:
- Added cell.visited exploration reward to incentivize navigation away from hub
- Stronger junction alignment reward (2.0 vs 1.0)
- Stronger aligner gear bonus (1.0 vs 0.5)
- Train with COGAMES_ENT_COEF=0.005 for more decisive movement
"""
