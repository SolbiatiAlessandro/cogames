"""Competition map training with 5-action space (no change_vibe).

KEY INSIGHT: Top RL policies (#1 Softy:v103 at 45.29) use ONLY 5 movement
actions (noop + 4 moves) with ZERO change_vibe calls. Reducing the action
space from 12 to 5 should dramatically improve learning speed and stability.

Uses NoVibesVariant to disable change_vibe + balanced reward structure.
Train to epoch 10 (where alignment typically peaks before collapse).
"""
