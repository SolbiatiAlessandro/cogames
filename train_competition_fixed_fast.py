"""Competition map, FIXED seed 42, SHORT episodes for fast iteration.

Key insight: shorter episodes (500 steps) = more episodes per epoch = faster learning.
Agents must learn to be efficient quickly (get gear, move to junction, align).
Fixed seed forces memorization of the specific map.
...
competition_basic.max_steps = 500
