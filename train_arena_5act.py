"""Arena training with 5-action space (no change_vibe).

Faster training (50x50 arena) to test the 5-action hypothesis.
Top RL policies use only 5 movement actions. This should simplify
learning and prevent action-space exploration waste.
"""
