"""Competition map with credit + entropy annealing.

Same approach as arena entanneal but on cogsguard_machina_1 (88x88 map).
Stronger reward weights + exploration bonus for larger map navigation.
