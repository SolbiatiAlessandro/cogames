"""Training mission: arena with braveheart (255 hearts) + deposit rewards.

Phase 1 of curriculum: unlimited hearts lets agents learn alignment fast.
Deposit rewards teach the mining chain simultaneously. After training,
fine-tune from checkpoint with initial_hearts=0 to learn self-sufficient
heart production.
"""
...
arena_basic.teams = {
    "cogs": CogTeam(name="cogs", num_agents=8, wealth=1, initial_hearts=255),
}
