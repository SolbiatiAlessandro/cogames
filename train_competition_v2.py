"""Competition map v2: stronger exploration + longer episodes.

Key changes from v1:
- max_steps=2000 (double: more time for navigation on 88x88 map)
- exploration_bonus weight=0.05 (5x: stronger drive to cover map)
- aligner_gear_bonus weight=5.0 (stronger gear pickup signal)
- heart_bonus weight=1.0 (explicit heart acquisition signal)

Use with: COGAMES_ENT_START=0.06 COGAMES_ENT_END=0.01 COGAMES_ENT_ANNEAL_EPOCHS=30
"""
