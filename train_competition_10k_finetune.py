"""Fine-tune best 1k-trained model on 10000-step competition episodes.

Strategy: The 1k model learned hub interactions (mining, crafting, hearts).
Fine-tuning on 10k episodes gives it time to learn navigation while
preserving existing skills. Uses low entropy to force directional commitment.
"""
